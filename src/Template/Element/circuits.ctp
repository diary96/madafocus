...
<div class="modal fade rsto-modal" id="rsto-circuit-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="rsto-circuit-form" name="rsto-circuit-form" class="rsto-form" role="form" data-x-csrf-token="<?= $x_csrf_token ?>" data-action-url="<?= $rsto_circuits_add_url ?>" data-edit-url="<?= $rsto_circuits_add_url ?>">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="rsto-circuit-tour-operateur"><?= __('Tour Operator') ?></label>
                        <select name="tour_operator" class="form-control" data-required="true" id="rsto-circuit-tour-operator" data-url="<?= $rsto_circuits_tour_operator_url ?>" data-placeholder="<?= __("Choose a tour operator") ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input name="start" type="date" class="form-control date-validation" data-required="true" id="rsto-circuit-departure" placeholder="<?= __("Pick the start date") ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input name="adults" type="text" class="form-control numeric-validation" data-required="true" placeholder="<?= __("Pax") ?>">
                    </div>
                    <div class="form-group">
                        <label for="rsto-circuit-pax"><?= __('Children count') ?></label>
                        <input name="childrens" type="text" class="form-control numeric-validation" data-required="true" placeholder="<?= __("Pax") ?>">
                    </div>
                    <div class="form-group">
                        <label for="rsto-circuit-driving-mode"><?= __('Driving mode') ?></label>
                        <select name="self_drive" class="form-control" data-required="true" id="rsto-circuit-tour-operator" data-url="" data-placeholder="<?= __("Choose the driving mode") ?>">
